...
import com.grass.picturebackend.api.aliyunai.AliYunAiApi;
import com.grass.picturebackend.api.aliyunai.model.CreateOutPaintingTaskResponse;
import com.grass.picturebackend.api.aliyunai.model.GetOutPaintingTaskResponse;
...
import com.grass.picturebackend.manager.auth.StpKit;
...
//    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    ...
    public BaseResponse<Boolean> updatePicture(@RequestBody PictureUpdateRequest pictureUpdateRequest, HttpServletRequest request) {
        ...
        updateWrapper.eq("spaceId", picture.getSpaceId());
